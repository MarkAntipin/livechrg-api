...
async def test_get_station_inner_id_and_source_by_station_id(client: TestClient, pg: asyncpg.Pool) -> None:
    # arrange
    ...
    assert resp.status_code == 200, f"Unexpected error: {station_sources.get('detail', 'No detail provided')}"
